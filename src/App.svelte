            ...
            <div class="container mx-auto px-4 pb-8">
                <div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                    ...
                    <!-- TODO: When we bring filters back, put search back to half width -->
                      ...
                      <form class="w-full" on:submit|preventDefault={() => window.open(`http://${dapps[0].domain}`, '_blank')}>
                        <span class="flex items-center">
                          ...
                          <div class="relative w-full">
                            ...
                            <input bind:this={searchInput} bind:value={searchTerm} on:keyup={onSearch} type="text" id="simple-search" class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search" required="">
                          </div>
                        </span>
                    </form>
